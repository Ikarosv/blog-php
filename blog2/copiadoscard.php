            ...
            <div class="bg-success d-flex flex-column align-items-center">
                ...
                <div class="w-100 row mt-2 mx-0 py-2">
                    ...
                    <div class="col-6 d-flex justify-content-center">
                            <div class="card text-black bg-white card-my mt-5" style="width: 100%;">
                                <div class="card-body d-flex flex-column align-items-center">
                                    <h4 class="card-title borda-card w-100">
                                        <?php echo $q['title'];?>
                                    </h4>
                                    <p class="card-text "><?php echo substr($q['content'],0,150);?>...</p>
                                    <a href="visualizar.php?id=<?php echo $q['id']?>" class="btn bot-card px-5">Ler mais</a>
                                </div>
                            </div>
                    </div>
                    <?php } ?>
