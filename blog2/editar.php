  ...
  <body>
    <div class="container mt-5">
        ...
        <form method="POST">
            ...
            <textarea name="content" class="form-control my-3 bg-dark text-white" col="30" rows="10"><?php echo $q['content']?></textarea>
            <button class="btn btn-dark" name="update">Editar</button>
